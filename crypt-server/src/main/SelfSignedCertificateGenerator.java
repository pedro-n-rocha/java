...
public class SelfSignedCertificateGenerator {
    ...
    public static Certificate getCerts(KeyPair keys) throws OperatorCreationException, IOException {
        return  getCertificate(keys) ;
    }

    private static X509Certificate getCertificate(KeyPair keys) throws OperatorCreationException, IOException {
        try {
    ...
    private static X509v1CertificateBuilder getCertificateBuilder(PublicKey publicKey) throws IOException {
    ...
    private static ContentSigner getSigner(KeyPair keys) throws OperatorCreationException {
